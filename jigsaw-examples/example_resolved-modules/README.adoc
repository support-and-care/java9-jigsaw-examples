...
=== JAR Naming for Module-Path and jlink
...
[NOTE]
====
While `--module-path target` would work for direct Java execution, jlink would output the full classifier-based names, breaking golden master verification.
