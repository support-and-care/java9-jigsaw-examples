...
The migration uses symbolic links from `m4/src/java/<module>/main` to `../../../../src/<module>`:

[source,bash]
----
m4/src/java/mod.main/main -> ../../../../src/mod.main
m4/src/java/mod.layer/main -> ../../../../src/mod.layer
m4/src/java/mod.y_bottom/main -> ../../../../src/mod.y_bottom
...
<sources>
  <source>
    ...
    <directory>src/java/mod.main/main</directory>
  </source>
  <source>
    <module>mod.layer</module>
    <directory>src/java/mod.layer/main</directory>
  </source>
