...
Since the migration to Maven 4 in this repository focuses on Java Modules-related features, and this example doesn't rely on Java Modules, there is no need for a separate Maven 4 migration demonstration here.
