...
Migrated for JPMS support documentation of Apache Maven^TM^ in the course of the https://open-elements.com/support-care-maven/[Maven Support & Care] program by https://github.com/ascheman[Gerd Aschemann] (and other team members) as https://github.com/ascheman/java9-jigsaw-examples[forked repository].
...
All the examples have been successfully tested with Windows (64bit), Linux and MacOSX - running Java 11 LTS and Java 17 LTS.
...
. Install Java JDK:
** *Recommended*: Java 17 LTS or later (works with all examples)
** *Minimum*: Java 11 LTS
...
[NOTE]
====
JDK 17 (or newer) is recommended for all examples.
...
All examples have been tested with Java 11 and Java 17 on Windows, Linux, and macOS.
...
| JDK | 11 LTS or 17 LTS | all examples at compile and runtime | Recommended: JDK 17 LTS | https://adoptium.net/ or https://sdkman.io/
